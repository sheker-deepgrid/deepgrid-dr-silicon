...
export default function Home(){
 ...
 <section className="content-section"><div className="section-label"><Eyebrow>WHAT THE NUMBERS MEAN</Eyebrow><span>PRE-SILICON, LABELLED</span></div>
